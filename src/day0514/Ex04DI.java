...
// 이러한 의존성을 줄이기 위해서 여러 방법이 시도 되었으나
// 가장 좋은 방법은 다음과 같은 방법으로 해소를 하는 것이다.

// 의존성은 2가지 방법으로 줄일 수 있는데.
// 2가지 방법 모두 B 라는 원본 클래스를 A가 직접 초기화를 하는 것이 아니라
// 외부에서 B 라는 클래스 객체를 만들어서 초기화하고
// A 에 해당 객체를 전달시켜서 사용하게 하는 방법이 된다.
// 방법 1: setter 를 통한 의존성 주입
// 방법 2: 생성자를 통한 의존성 주입
